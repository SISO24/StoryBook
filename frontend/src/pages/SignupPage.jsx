  ...
  return (
    <>
      <div className="w-full flex flex-col md:flex-row">
        {/* Left Section */}
        <div className="bg-[#191919] md:bg-[#111111] md:w-2/5 lg:w-1/2 flex flex-col">
          {/* Logo */}
          <div className="mt-4 ml-4 flex items-center">
            ...
            <span className="text-white font-semibold text-xl tracking-tight ml-2">
              StoryBook
            </span>
          </div>
        ...
        <div className="bg-[#191919] w-full md:w-3/5 lg:w-1/2 min-h-screen flex flex-col justify-start md:justify-center items-center px-6 sm:px-8 pt-20 pb-12">
          <div className="w-full max-w-md space-y-10">
            ...
            {/* Login Link */}
            <p className="text-center text-[#a8a8a8] text-base font-light pb-8">
